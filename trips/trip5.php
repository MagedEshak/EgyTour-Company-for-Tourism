        ...
        <div class="container">
            ...
            <div class="links">
                ...
                <ul>
                    ...
                    <li class="pro"><a href="../login/show-data.php"><img style="width: 35px;"
                                src="../photos/person.png" alt="Profile"></i></a></i></a>
                        <ul>
        ...
        <div class="w3-main w3-white">
            ...
            <div class="w3-container" id="apartment">
                ...
                <div class="w3-display-container mySlides">
                    <img src="../photos/services/Trips/sharm/trip2/<?php echo $Trips_row['photo']; ?>"
                        style="width:100%;margin-bottom:-6px">

                </div>
                <div class="w3-display-container mySlides">
                    <img src="../photos/services/Trips/sharm/trip2/<?php echo $Trips_row['photo2']; ?>"
                        style="width:100%;margin-bottom:-6px">

                </div>
                <div class="w3-display-container mySlides">
                    <img src="../photos/services/Trips/sharm/trip2/<?php echo $Trips_row['photo3']; ?>"
                        style="width:100%;margin-bottom:-6px">

                </div>
                <div class="w3-display-container mySlides">
                    <img src="../photos/services/Trips/sharm/trip2/<?php echo $Trips_row['photo4']; ?>"
                        style="width:100%;margin-bottom:-6px">
            ...
            <div class="w3-row-padding w3-section">
                <div class="w3-col s3">
                    <img class="demo w3-opacity w3-hover-opacity-off"
                        src="../photos/services/Trips/sharm/trip2/<?php echo $Trips_row['photo']; ?>"
                        style="width:100%;cursor:pointer" onclick="currentDiv(1)">
                </div>
                <div class="w3-col s3">
                    <img class="demo w3-opacity w3-hover-opacity-off"
                        src="../photos/services/Trips/sharm/trip2/<?php echo $Trips_row['photo2']; ?>"
                        style="width:100%;cursor:pointer" onclick="currentDiv(2)">
                </div>
                <div class="w3-col s3">
                    <img class="demo w3-opacity w3-hover-opacity-off"
                        src="../photos/services/Trips/sharm/trip2/<?php echo $Trips_row['photo3']; ?>"
                        style="width:100%;cursor:pointer" onclick="currentDiv(3)">
                </div>
                <div class="w3-col s3">
                    <img class="demo w3-opacity w3-hover-opacity-off"
                        src="../photos/services/Trips/sharm/trip2/<?php echo $Trips_row['photo4']; ?>"
            ...
            <div class="w3-container">
                ...
                <div class="w3-container w3-display-container w3-padding-16">
                    ...
                    <h5> per person</h5>
                    <hr>
                    <form action="booking_info/booking_information4.php" method="POST">
