        ...
        <div class="w3-container w3-display-container w3-padding-16" style="width: 50%; position: relative; left: 25%;">
            <div class="w3-content w3-border-left w3-border-right w3-container w3-display-container w3-padding-16"
                ...
                <form action="../../../database/edit.php" method="POST">
                    ...
                    <input class="w3-input w3-border" type="text" placeholder="Enter the New User Name"
                        name="user_name"><br>

                    <p><label> Email</label></p>
                    <input class="w3-input w3-border" type="email"
                        placeholder="Enter the New Email ---> note: The New Email must be uniqe" name="user_email"><br>

                    <p><label> Mobile Phone</label></p>
                    <input class="w3-input w3-border" type="text" maxlength="11" placeholder="ex: 012345678910"
                        placeholder="Enter the New Mobile Phone" name="user_phone"><br>

                    <p><button class="w3-button w3-green " style="width: 100%;" type="submit"
                            name="edit_user">Edit</button>
                    </p>
